...
**🔗 题目链接：**  
**[minimum-cost-path-with-teleportations](https://leetcode.cn/problems/minimum-cost-path-with-teleportations/)**
---
...
解题思路：
按格子值排序 + 批量更新 + 反向 DP，多轮迭代允许修改 k 个格子，实现最小路径代价优化。（题目过难）
